      ...
      >
        ...
        <div className="relative z-10 items-center justify-center flex flex-col space-y-5">
          ...
          <p className="mt-2 text-lg xl:text-xl max-w-[600px] font-serif">
            ...
            React Native, React, Node.js, MongoDB, and Express, I create
            efficient and user-friendly digital solutions. From eCommerce
            platforms and BookStore applications to real-time chat apps, I bring
            ideas to life with clean code and modern design. Let's build
...
>
  Download
  <p className="absolute z-40 font-semibold bg-gradient-to-r from-green-700 to-lime-500 bg-clip-text text-transparent top-1/2 left-1/2 -translate-x-1/2 group-hover:-translate-y-full h-full w-full transition-all duration-300 -translate-y-[30%] tracking-wide">
    RESUME
  </p>
  ...
  >
    <defs>
      <linearGradient id="green-grad" y2="100%" x2="50%" y1="0%" x1="50%">
        <stop offset="0%" stopOpacity="1" stopColor="hsl(120, 60%, 55%)"></stop>
        <stop offset="100%" stopOpacity="1" stopColor="hsl(90, 65%, 45%)"></stop>
      </linearGradient>
    </defs>
    <g transform="matrix(1,0,0,1,0,-91.0877685546875)" fill="url(#green-grad)">
      <path
        opacity="0.05"
